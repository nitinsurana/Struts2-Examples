...
// All Record
    ...
    public String execute() throws Exception {
        System.out.println("StateAction : " + id + "    " + idcountry);
        myList = new DAO().genLstState(id);
...
//                    setGridModel(.findbyName(searchString));
    ...
    public List<State> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<State> gridModel) {
