 ...
 */
public class MyJsonInterceptor extends AbstractInterceptor {
    
    private static final long serialVersionUID = 4950170304212158803L;
    private static final Logger LOG = LoggerFactory.getLogger(MyJsonInterceptor.class);
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        System.out.println("N Param : " + request.getParameter("struts.enableJSONValidation"));
        ...
        if ((contentType != null) && contentType.equalsIgnoreCase("application/json")) {
            ...
            if (obj instanceof Map) {
                ...
                try {
                    ...
                    ex.printStackTrace();
                    ((ActionSupport)invocation.getAction()).addActionError(ex.getMessage());
//                    return Action.INPUT;
                }
            } else {
    ...
    /**
     * Returns the appropriate set of includes, based on debug setting. Derived
