...
//		sInput = in.readLine();
    ...
    public static void find_match() {
        ...
        for (int i = 0; i < KnowledgeBase.length; ++i) {
            ...
            //Assuming that the last entry in keyword list is the name of the supporting image
            //and hence comparing uptil second last keywords only
            for (int j = 0; j < keyWordList.length-1; ++j) {
...
//                    }
                    ...
                    if (keyWord.length() > bestKeyWord.length()) {
                        ...
                        picLocation=KnowledgeBase[i][0][keyWordList.length-1];
                        System.out.println("piclocation : "+picLocation);
//                        JOptionPane.showMessageDialog(null, picLocation + " "+i+"   "+j+" "+(keyWordList.length-1));
...
//            System.out.println(sResponse);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            while (!quit()) {
//                            get_input();
                System.out.println(get_input("how do you do"));
